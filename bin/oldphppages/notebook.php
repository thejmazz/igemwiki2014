		...
		<table width="70%" align="center">
			...
			<tr>
				...
				<p style="color:#E7E7E7">
					<a href="http://2014.igem.org/wiki/index.php?title=Team:Toronto/Notebook&action=edit"style="color:#FFFFFF"> Click here  to edit this page!</a>
				</p></td>
			</tr>
			...
			<tr>
				<td colspan="3"><h3>Notebook</h3></td>
			</tr>
			</tr>
