		...
		<table width="70%" align="center">
			...
			<tr>
				...
				<p style="color:#E7E7E7">
					<a href="http://2014.igem.org/wiki/index.php?title=Team:Toronto/Parts&action=edit"style="color:#FFFFFF"> Click here  to edit this page!</a>
				</p></td>
			</tr>
			...
			<tr>
				...
				</p><h3>When should you put parts into the Registry?</h3>
				<p>
